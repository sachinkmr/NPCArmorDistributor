...
using log4net;
using NPCArmorDistributor.Managers;

namespace NPCArmorDistributor.Utils
{
    public class OutfitUtils
    {
        ...
        {
            LeveledItem mLL = LeveledListUtils.CreateLeveledList(PatchedMod, set, "mLL_" + eid, 1, Program.Settings.LeveledListFlag);
